...
\usepackage{amsmath, amssymb, commath, pgfplots, datetime, color, nicefrac}                         % get the packages we depend on
...
\end{align*}
\begin{figure}[h]
    \includegraphics[width=1.0\linewidth]{single_path.pdf}
...
\includegraphics[width=1.0\linewidth]{betaplot_fixed.png}
